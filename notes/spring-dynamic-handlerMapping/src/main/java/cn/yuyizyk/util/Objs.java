...
public class Objs {
	 ...
	 * @return
	 */
	public static final boolean anyEmpty(final Object arg, final Object... args) {
		return isEmpty(arg) || anyEmpty(args);
	}
	...
	public static final boolean anyEmpty(final Object[] args) {
		if (isEmpty(args))
			return true;
		for (int i = 0; i < args.length; i++) {
			if (isEmpty(args[i]))
